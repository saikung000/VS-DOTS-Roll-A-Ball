...
namespace Packages.VisualScripting.Editor.Stencils
{
    ...
    {
        public static ComponentQueryDeclarationModel CreateComponentQuery(this VSGraphModel graphModel, string groupName)
        {
            var field = VariableDeclarationModel.CreateDeclarationNoUndoRecord<ComponentQueryDeclarationModel>(groupName,
                typeof(EntityQuery).GenerateTypeHandle(graphModel.Stencil),
                true,
                graphModel,
                VariableType.ComponentGroupField,
