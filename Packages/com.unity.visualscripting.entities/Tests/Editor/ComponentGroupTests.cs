...
{
    public class ComponentGroupTests : BaseFixture
    {
        ...
        [Test]
        public void CreateComponentGroupFromGameObjectAction([Values] TestingMode mode)
        {
        ...
        [Test]
        public void CreateComponentGroupAndNodeFromGameObjectAction([Values] TestingMode mode)
        {
            var gameObject = new GameObject();
