...
namespace UnityEditor.VisualScripting.Editor
{
    ...
    class StickyNote : GraphElement, IHasGraphElementModel, IResizable, IMovable
    {
        ...
        GraphViewModel.StickyNoteTheme Theme => stickyNoteModel.Theme;
        ...
        {
            foreach (GraphViewModel.StickyNoteTheme value in Enum.GetValues(typeof(GraphViewModel.StickyNoteTheme)))
