...
namespace UnityEditor.VisualScripting.Model
{
    ...
    public abstract class PropertyGroupBaseNodeModel : NodeModel, IHasInstancePort
    {
        ...
        public void AddMember(Type type, string memberName)
        {
            ...
            Undo.RegisterCompleteObjectUndo(NodeAssetReference, "Add Member");
        ...
        public void AddMember(TypeMember member)
        {
            ...
            Undo.RegisterCompleteObjectUndo(NodeAssetReference, "Add Members");
            m_Members.Add(member);
        ...
        {
            Undo.RegisterCompleteObjectUndo(NodeAssetReference, "Remove Members");
